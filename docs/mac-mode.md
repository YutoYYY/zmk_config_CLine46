...
- Layer 0〜11 すべて、これまでどおり DYAStudio で中身を変更できます。
- Mac 用レイヤー(7〜11)は、▽(透過)にしたキーは下の Windows 用レイヤーのキーがそのまま使われます。Windows 側に新しいショートカットを足したら、必要に応じて Mac 用レイヤーの同じ位置にも Mac 版を置いてください。
